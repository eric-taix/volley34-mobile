...
class _ClubStatisticsState extends State<ClubStatistics> {
  ...
  List<BarChartGroupData> showingGroups(SetsDistribution setsDistribution) => [
        ...
        makeGroupData(1, setsDistribution.s31.toDouble(), setsDistribution.maxValue.toDouble(), barColor: Colors.greenAccent),
        makeGroupData(2, setsDistribution.s32.toDouble(), setsDistribution.maxValue.toDouble(), barColor: Colors.yellowAccent),
        makeGroupData(3, setsDistribution.s23.toDouble(), setsDistribution.maxValue.toDouble(), barColor: Colors.orangeAccent),
        makeGroupData(4, setsDistribution.s13.toDouble(), setsDistribution.maxValue.toDouble(), barColor: Colors.deepOrangeAccent),
        makeGroupData(5, setsDistribution.s03.toDouble(), setsDistribution.maxValue.toDouble(), barColor: Colors.redAccent),
      ];
