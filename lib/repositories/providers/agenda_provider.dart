...
class AgendaProvider {
  Future<List<Event>> listTeamIncomingMatches(String? teamCode) async {
    Response response = await dio.get("/equipes/$teamCode/matchs?filter=next");
  ...
  Future<List<Event>> listTeamAllMatches(String? teamCode) async {
