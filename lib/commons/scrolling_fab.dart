...
class _ScrollingFabAnimatedState extends State<ScrollingFabAnimated> with SingleTickerProviderStateMixin {
    ...
    return InkWell(
      ...
      child: Card(
        ...
        child: AnimatedContainer(
          ...
          decoration:
              BoxDecoration(color: widget.color, borderRadius: BorderRadius.all(Radius.circular(widget.height! / 2))),
          child: Row(
