    ...
    return BlocBuilder(
      ...
      builder: (context, state) {
        if (state is ClubLoadedState) {
          return Text(state.club.name, textAlign: TextAlign.left, style: Theme.of(context).textTheme.bodyText1.copyWith(color: Theme.of(context).textTheme.bodyText2.color));
        } else {
          return Loading();
        }
      },
