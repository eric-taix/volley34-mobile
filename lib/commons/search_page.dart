...
class SearchPage<T> extends SearchDelegate<T?> {
  ...
  final void Function(String, List<T>)? onQueryUpdate;
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    List<T> result = filterItems();
    // Calles the 'onQueryUpdated' functions at the start of the operation
    if (onQueryUpdate != null) onQueryUpdate!(query, result);
    ...
    return Theme(
      ...
      child: Stack(
        children: [
          cleanQuery.isEmpty && !showItemsOnEmpty
              ? suggestion
              : result.isEmpty
                  ? failure
