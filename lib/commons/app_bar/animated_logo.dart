...
class AnimatedLogo extends StatefulWidget {
  ...
  AnimatedLogo(
      {this.expandedHeight, this.imageUrl, this.heroTag, this.compute});

  @override
  __AnimatedLogoState createState() => __AnimatedLogoState();
}

class __AnimatedLogoState extends State<AnimatedLogo>
    ...
    return Positioned(
      ...
      child: Container(
        decoration: BoxDecoration(
          border: Border.all(
              color: Theme.of(context).appBarTheme.backgroundColor!, width: 0),
